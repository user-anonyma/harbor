...
export function PeekHero({ slides }: { slides: Meta[] }) {
  ...
  return (
    <div
      ...
      onKeyDown={(e) => {
        // Left/Right move between banners so the remote isn't stuck on the hero.
        ...
        {active && (
          <>
            <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-[12px] uppercase tracking-[0.18em] text-white/70">
              ...
              <span className="flex items-center gap-3 normal-case tracking-normal text-[13px] font-semibold text-white">
                <HeroRatingBadges
