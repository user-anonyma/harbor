...
export const TopRankCard = memo(function TopRankCard({ meta, rank }: { meta: Meta; rank: number }) {
  ...
  return (
    <button
      ...
      className="harbor-card-focus group relative w-full min-w-0"
    ...
    >
      ...
      <div
        ...
        className="absolute end-0 top-0 z-10 w-[60%] transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0.24,1)] group-hover:-translate-y-2 group-focus-within:-translate-y-2"
      >
        <Poster
          src={poster.src}
          ...
          seed={meta.id}
          ratio="portrait"
          className="harbor-card-ring rounded-xl shadow-[0_0_0_rgba(0,0,0,0)] transition-shadow duration-300 group-hover:shadow-[0_24px_44px_-14px_rgba(0,0,0,0.6)] group-focus-within:shadow-[0_24px_44px_-14px_rgba(0,0,0,0.6)]"
        />
