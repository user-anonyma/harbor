...
export function WatchlistTab() {
  ...
  // Watchlist = strictly the user's Trakt watchlist (+ Harbor's own local
  // watchlist adds). The Stremio library is intentionally excluded because it
  // includes watched titles, which shouldn't appear on the watchlist.
  const merged = useMemo(
    () => mergeWatchlist(localEntries, [], trakt),
    [localEntries, trakt],
  );
